...
const T = {
  en: {
    ...
    'usp.eyebrow': 'What only Blue Moon offers', 'usp.h2': 'Three things<br/><i>only at Blue Moon</i>', 'usp.01.title': 'Pre-session<br/><i>consultation</i>', 'usp.01.desc': "Before your shoot, Blue Moon consults on your concept and helps you choose outfits from the studio's wardrobe via Zalo. On shoot day, you walk in and start enjoying immediately. Nothing left to worry about.", 'usp.02.title': 'A team with you<br/><i>throughout</i>', 'usp.02.desc': 'The photographer and posing assistant stay with you from start to finish, no rush, no pressure. The session continues until you have all the frames you love.', 'usp.03.title': 'Original files delivered<br/><i>the same day</i>', 'usp.03.desc': 'All retouched photos delivered same day or within 24 hours. Full-resolution originals, print-ready at any size, kept forever.',
    ...
    'proc.02.time': 'Day 1 – 3', 'proc.02.title': 'Concept consultation', 'proc.02.desc': 'We suggest concepts suited to your body, personality, and story. Preview outfits, backgrounds, and the planned moodboard.',
    ...
    'faq.q1': 'What do I need to prepare before the session?', 'faq.a1': 'Blue Moon prepares all outfits and accessories for the agreed concept. You just need to arrive on time with a relaxed mind. The team will send a detailed prep list via Zalo 2–3 days before, including tips on nails, hair, and things to note.',
  ...
  vi: {
    ...
    'proc.02.time': 'Ngày 1 – 3', 'proc.02.title': 'Tư vấn concept', 'proc.02.desc': 'Gợi ý concept phù hợp với vóc dáng, tính cách và câu chuyện của bạn. Xem trước trang phục, background và moodboard dự kiến.',
